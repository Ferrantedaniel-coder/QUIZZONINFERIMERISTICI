...
4. Merge the pull request. The merged pull-request event deploys current main, then prunes the previous github-pages deployment history and old Pages artifacts.
